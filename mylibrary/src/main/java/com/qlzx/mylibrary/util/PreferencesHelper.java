...
public class PreferencesHelper {
    ...
    public Integer getDownloadId(){
        return getInt(DOWNLOADID,DOWNLOADID,0);
    }
     ...
     * @param isDownload
     */
    public void saveDownloadID(int isDownload){
        saveInt(DOWNLOADID,DOWNLOADID,isDownload);
    }
    /**
     * 获取下载状态
     ...
     * @param isDownload
     */
    public void saveIsDownload(Boolean isDownload){
        saveBoolean(ISDOWNLOAD,ISDOWNLOAD,isDownload);
    }
