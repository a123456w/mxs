...
public class OrderWaitDeliverFragment extends BaseFragment implements OnItemChildClickListener, OnRVItemClickListener,
    ...
    public void getData() {
        isLazy = true;
        getOrderList(helper.getToken(), "3", page);
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && isLazy){
            LogUtil.i("userVisible_OrderWaitDeliverFragment: "+isVisibleToUser);
            getData();
        }
    }
}
