package com.guo.qlzx.maxiansheng.util.crash;
...
import com.guo.qlzx.maxiansheng.util.file.FileUtils;
...
public class CrashHandlerUtil  implements Thread.UncaughtExceptionHandler {
        ...
        private boolean handleException(final Throwable throwable) {
            ...
            //保存日志文件
            String crashInfo = saveCrashInfo2File(throwable);
            FileUtils.writeTxtToFile(crashInfo,"/crash/","crashInfo.txt");
            //请求网络上传bug信息
            return true;
        }
        ...
        public void collectDeviceInfo(Context ctx) {
            ...
            infos.put("时间",formatter.format(Calendar.getInstance().getTimeInMillis()));
            try {
