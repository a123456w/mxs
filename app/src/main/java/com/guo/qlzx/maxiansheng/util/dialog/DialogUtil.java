...
public class DialogUtil {
     ...
     * @return 对话框
     */
    public static android.app.AlertDialog showAlert(Context context, String title, String message,
    ...
    {
        android.app.AlertDialog.Builder promptBuilder = new android.app.AlertDialog.Builder(context);
        if (title != null)
        {
        ...
        android.app.AlertDialog alertDialog = promptBuilder.create();
     ...
     * @return 对话框
     */
    public static android.app.AlertDialog showConfirm(Context context, String title, String message,
     ...
     */
    public static android.app.AlertDialog showPrompt(Context context, String message, String confirmButton)
    {
     ...
     * @param message 提示的消息
     */
    public static android.app.AlertDialog showPrompt(Context context, String message)
    {
