...
public class OrderAllFragment extends BaseFragment implements OnItemChildClickListener, OnRVItemClickListener,
    ...
    public void getData() {
        isLazy = true;
        getOrderList(helper.getToken(), "0", page);
            ...
            public void onGotoPayListener(int state) {
                switch (state) {
                    case 0:
                        ...
                        break;
                    case 1:
                        ToastUtil.showToast(mContext, "余额支付");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && isLazy){
            LogUtil.i("userVisible_OrderAllFragment: "+isVisibleToUser);
            getData();
        }
    }
    /**
