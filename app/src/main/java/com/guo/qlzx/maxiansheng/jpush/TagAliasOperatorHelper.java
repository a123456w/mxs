...
public class TagAliasOperatorHelper {
            ...
            switch (msg.what){
                case DELAY_SEND_ACTION:
                    if(msg.obj !=null && msg.obj instanceof  TagAliasBean){
                        ...
                        LogUtil.d(TAG,"#unexcepted - msg obj was incorrect");
                    }
                    break;
            }
        }
    ...
    public void handleAction(Context context, int sequence, TagAliasBean tagAliasBean){
        ...
        if(tagAliasBean == null){
            LogUtil.d(TAG,"tagAliasBean was null");
            return;
        }
        ...
        if(tagAliasBean.isAliasAction){
            switch (tagAliasBean.action){
                ...
                case ACTION_SET:
                    ...
                    break;
                default:
                    LogUtil.d(TAG,"unsupport alias action type");
                    return;
            }
        }else {
            switch (tagAliasBean.action) {
                ...
                case ACTION_CLEAN:
                    ...
                    break;
                default:
                    LogUtil.d(TAG,"unsupport tag action type");
                    return;
            }
        }
    }
