package com.guo.qlzx.maxiansheng.jpush;
...
import com.guo.qlzx.maxiansheng.activity.PutForwardActivity;
...
//				processCustomMessage(context, bundle);
				...
				try {
					...
					e.printStackTrace();
					//打开自定义的Activity
					Intent i = new Intent(context, MyBalanceActivity.class);
					i.putExtra("ISBALANCE",0);
